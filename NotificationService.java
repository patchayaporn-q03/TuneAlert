...
public final class NotificationService {
    ...
    public NotificationService(List<Notifier> channels, Priority threshold) {
        ...
        if(channels == null || channels.contains(null)) throw new IllegalArgumentException("ห้าม null/มีสมาชิก null");
        if(threshold == null) throw new IllegalArgumentException("ห้าม null");
